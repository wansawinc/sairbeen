...
# -----------------------------------------------------------------------------------
os.system('yt-dlp -c -f "bestaudio" --playlist-items 1 -o "audio.%(ext)s" "https://www.youtube.com/playlist?list=PLdX__8WPbfkpAP-52xblaibP3NUTO3mnt"')
os.system('mv audio.m4a Sairbeen$(date +%d-%b-%g).m4a')
video_path = ('Sairbeen$(date +%d-%b-%g).m4a')
# -----------------------------------------------------------------------------------
